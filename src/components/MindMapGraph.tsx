...
class MindMapGraph extends  Component<Props, State> {
  ...
  draw(){
    ...
    //@ts-ignore
    svg = svg.attr("viewBox", [0, 0, this.props.width, this.props.height]);
